...
const IOS_HELP_TOPICS: HelpTopic[] = [
  {
    ...
    content:
      "We currently do not support saving recipes. This feature will be added in an upcoming release. In the meantime, continue to enjoy playing around in the recipe playground!",
  },
  {
...
const Help = () => {
  return (
    <>
      ...
      <Typography>
        If you don&apos;t see your question listed above, please Contact Us and
